...
- `spar` runs an optional read-only cross-model review of a plan, diff, or decision. Claude Code reviews with `spar-codex`; Codex and OpenCode review with `spar-claude`. Consult the maintenance ledger for active bridge availability.
